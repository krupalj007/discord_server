    ...
    return (
       <div>
        ...
        <DialogDescription className="text-center text-zinc-500 ">
            Give your server a personality with a name ans an image. You can always change it later.
        </DialogDescription>
            </DialogHeader>
...
<Form {...form}>
  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
       ...
       />
            ...
            render={({field})=> (
                <FormItem>
                    <FormLabel className="uppercase  text-xs font-bold text-zinc-500 dark:text-secondary/70">Name Of Server</FormLabel>
                    <FormControl>
                        <Input 
                        className="bg-zinc-400/50 border-0 focus-visible:ring-0 text-black focus-visible:ring-offset-0"
                        placeholder="E.g. Enter server name"
                        {...field}
                        />
                    </FormControl>
                    <FormMessage />
