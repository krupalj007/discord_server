...
const words = [
    {
      text: "Where you can collaborate, share & just talk about your day.",
...
<div className="relative bg-gradient-to-b from-white to-blue-300 h-screen overflow-hidden">
    <div className="absolute inset-0 z-0">
        <div
            className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50% + 18rem)] sm:w-[36.125rem] w-[18.125rem] h-[calc(100vh + 10rem)] rounded-full animate-spin"
            style={{
                clipPath:
    ...
    <div className="relative z-10 flex justify-center items-center h-full">
        <div className="max-w-2xl px-6 py-32 sm:py-48 lg:py-56 text-center">
            ...
            <div>
                ...
                <h6 className="mt-6 text-lg leading-8 text-gray-600">
  ...
  <div className="relative z-10 flex justify-center items-center h-full">
    <div className="max-w-2xl flex px-6 py-32 sm:py-48 lg:py-56 text-center">
      <div className="mx-auto grid flex max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
